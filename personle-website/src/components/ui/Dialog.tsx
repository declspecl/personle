		...
		<DialogPortal>
			...
			>
				<SkewedContainer deltaWidthRem={1} skewDirection="right" className="p-1 w-full h-full bg-white">
					<SkewedContainer deltaWidthRem={1} skewDirection="right" className="p-8 w-full h-full bg-black text-white">
						{children}

						<DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-80 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
