...
use crate::{model::{DamageType, FusionMethod, MegatenFusionToolPersonaData, PersonaData, Stat}, utils::{try_parse_megaten_fusion_tool_resistances_string, ResistanceLevel}};
...
) -> anyhow::Result<Vec<PersonaData>>
{
    ...
    for (persona_name, megaten_data) in megaten_persona_data_by_name.into_iter()
    {
        ...
        let current_persona_data = PersonaData::new(
            persona_name,
            megaten_data.lvl,
            megaten_data.race,
            fusion_method,
